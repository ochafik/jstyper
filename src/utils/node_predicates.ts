...
export function isFunctionLikeDeclaration(decl: ts.Node): decl is ts.FunctionLikeDeclaration {
    switch (decl.kind) {
...
export function isEndOfFileToken(node: ts.Node): node is ts.Token<ts.SyntaxKind.EndOfFileToken> {
...
export function isOpenBraceToken(node: ts.Node): node is ts.Token<ts.SyntaxKind.OpenBraceToken> {
  return node.kind === ts.SyntaxKind.OpenBraceToken;
}
export function isCloseBraceToken(node: ts.Node): node is ts.Token<ts.SyntaxKind.CloseBraceToken> {
  return node.kind === ts.SyntaxKind.CloseBraceToken;
}
export function isOpenParenToken(node: ts.Node): node is ts.Token<ts.SyntaxKind.OpenParenToken> {
  return node.kind === ts.SyntaxKind.OpenParenToken;
}
export function isCloseParenToken(node: ts.Node): node is ts.Token<ts.SyntaxKind.CloseParenToken> {
  return node.kind === ts.SyntaxKind.CloseParenToken;
}
export function isOpenBracketToken(node: ts.Node): node is ts.Token<ts.SyntaxKind.OpenBracketToken> {
  return node.kind === ts.SyntaxKind.OpenBracketToken;
}
export function isCloseBracketToken(node: ts.Node): node is ts.Token<ts.SyntaxKind.CloseBracketToken> {
  return node.kind === ts.SyntaxKind.CloseBracketToken;
}
export function isDotToken(node: ts.Node): node is ts.Token<ts.SyntaxKind.DotToken> {
  return node.kind === ts.SyntaxKind.DotToken;
}
export function isDotDotDotToken(node: ts.Node): node is ts.Token<ts.SyntaxKind.DotDotDotToken> {
  return node.kind === ts.SyntaxKind.DotDotDotToken;
}
export function isSemicolonToken(node: ts.Node): node is ts.Token<ts.SyntaxKind.SemicolonToken> {
...
export function isLessThanToken(node: ts.Node): node is ts.Token<ts.SyntaxKind.LessThanToken> {
  return node.kind === ts.SyntaxKind.LessThanToken;
}
export function isLessThanSlashToken(node: ts.Node): node is ts.Token<ts.SyntaxKind.LessThanSlashToken> {
  return node.kind === ts.SyntaxKind.LessThanSlashToken;
}
export function isGreaterThanToken(node: ts.Node): node is ts.Token<ts.SyntaxKind.GreaterThanToken> {
  return node.kind === ts.SyntaxKind.GreaterThanToken;
}
export function isLessThanEqualsToken(node: ts.Node): node is ts.Token<ts.SyntaxKind.LessThanEqualsToken> {
  return node.kind === ts.SyntaxKind.LessThanEqualsToken;
}
export function isGreaterThanEqualsToken(node: ts.Node): node is ts.Token<ts.SyntaxKind.GreaterThanEqualsToken> {
  return node.kind === ts.SyntaxKind.GreaterThanEqualsToken;
}
export function isEqualsEqualsToken(node: ts.Node): node is ts.Token<ts.SyntaxKind.EqualsEqualsToken> {
  return node.kind === ts.SyntaxKind.EqualsEqualsToken;
}
export function isExclamationEqualsToken(node: ts.Node): node is ts.Token<ts.SyntaxKind.ExclamationEqualsToken> {
  return node.kind === ts.SyntaxKind.ExclamationEqualsToken;
}
export function isEqualsEqualsEqualsToken(node: ts.Node): node is ts.Token<ts.SyntaxKind.EqualsEqualsEqualsToken> {
  return node.kind === ts.SyntaxKind.EqualsEqualsEqualsToken;
}
export function isExclamationEqualsEqualsToken(node: ts.Node): node is ts.Token<ts.SyntaxKind.ExclamationEqualsEqualsToken> {
  return node.kind === ts.SyntaxKind.ExclamationEqualsEqualsToken;
}
export function isEqualsGreaterThanToken(node: ts.Node): node is ts.Token<ts.SyntaxKind.EqualsGreaterThanToken> {
  return node.kind === ts.SyntaxKind.EqualsGreaterThanToken;
}
export function isPlusToken(node: ts.Node): node is ts.Token<ts.SyntaxKind.PlusToken> {
  return node.kind === ts.SyntaxKind.PlusToken;
}
export function isMinusToken(node: ts.Node): node is ts.Token<ts.SyntaxKind.MinusToken> {
  return node.kind === ts.SyntaxKind.MinusToken;
}
export function isAsteriskToken(node: ts.Node): node is ts.Token<ts.SyntaxKind.AsteriskToken> {
  return node.kind === ts.SyntaxKind.AsteriskToken;
}
export function isAsteriskAsteriskToken(node: ts.Node): node is ts.Token<ts.SyntaxKind.AsteriskAsteriskToken> {
  return node.kind === ts.SyntaxKind.AsteriskAsteriskToken;
}
export function isSlashToken(node: ts.Node): node is ts.Token<ts.SyntaxKind.SlashToken> {
  return node.kind === ts.SyntaxKind.SlashToken;
}
export function isPercentToken(node: ts.Node): node is ts.Token<ts.SyntaxKind.PercentToken> {
  return node.kind === ts.SyntaxKind.PercentToken;
}
export function isPlusPlusToken(node: ts.Node): node is ts.Token<ts.SyntaxKind.PlusPlusToken> {
  return node.kind === ts.SyntaxKind.PlusPlusToken;
}
export function isMinusMinusToken(node: ts.Node): node is ts.Token<ts.SyntaxKind.MinusMinusToken> {
  return node.kind === ts.SyntaxKind.MinusMinusToken;
}
export function isLessThanLessThanToken(node: ts.Node): node is ts.Token<ts.SyntaxKind.LessThanLessThanToken> {
  return node.kind === ts.SyntaxKind.LessThanLessThanToken;
}
export function isGreaterThanGreaterThanToken(node: ts.Node): node is ts.Token<ts.SyntaxKind.GreaterThanGreaterThanToken> {
  return node.kind === ts.SyntaxKind.GreaterThanGreaterThanToken;
}
export function isGreaterThanGreaterThanGreaterThanToken(node: ts.Node): node is ts.Token<ts.SyntaxKind.GreaterThanGreaterThanGreaterThanToken> {
  return node.kind === ts.SyntaxKind.GreaterThanGreaterThanGreaterThanToken;
}
export function isAmpersandToken(node: ts.Node): node is ts.Token<ts.SyntaxKind.AmpersandToken> {
  return node.kind === ts.SyntaxKind.AmpersandToken;
}
export function isBarToken(node: ts.Node): node is ts.Token<ts.SyntaxKind.BarToken> {
  return node.kind === ts.SyntaxKind.BarToken;
}
export function isCaretToken(node: ts.Node): node is ts.Token<ts.SyntaxKind.CaretToken> {
  return node.kind === ts.SyntaxKind.CaretToken;
}
export function isExclamationToken(node: ts.Node): node is ts.Token<ts.SyntaxKind.ExclamationToken> {
  return node.kind === ts.SyntaxKind.ExclamationToken;
}
export function isTildeToken(node: ts.Node): node is ts.Token<ts.SyntaxKind.TildeToken> {
  return node.kind === ts.SyntaxKind.TildeToken;
}
export function isAmpersandAmpersandToken(node: ts.Node): node is ts.Token<ts.SyntaxKind.AmpersandAmpersandToken> {
  return node.kind === ts.SyntaxKind.AmpersandAmpersandToken;
}
export function isBarBarToken(node: ts.Node): node is ts.Token<ts.SyntaxKind.BarBarToken> {
  return node.kind === ts.SyntaxKind.BarBarToken;
}
export function isQuestionToken(node: ts.Node): node is ts.Token<ts.SyntaxKind.QuestionToken> {
  return node.kind === ts.SyntaxKind.QuestionToken;
}
export function isColonToken(node: ts.Node): node is ts.Token<ts.SyntaxKind.ColonToken> {
  return node.kind === ts.SyntaxKind.ColonToken;
}
export function isAtToken(node: ts.Node): node is ts.Token<ts.SyntaxKind.AtToken> {
  return node.kind === ts.SyntaxKind.AtToken;
}
export function isEqualsToken(node: ts.Node): node is ts.Token<ts.SyntaxKind.EqualsToken> {
  return node.kind === ts.SyntaxKind.EqualsToken;
}
export function isPlusEqualsToken(node: ts.Node): node is ts.Token<ts.SyntaxKind.PlusEqualsToken> {
  return node.kind === ts.SyntaxKind.PlusEqualsToken;
}
export function isMinusEqualsToken(node: ts.Node): node is ts.Token<ts.SyntaxKind.MinusEqualsToken> {
  return node.kind === ts.SyntaxKind.MinusEqualsToken;
}
export function isAsteriskEqualsToken(node: ts.Node): node is ts.Token<ts.SyntaxKind.AsteriskEqualsToken> {
  return node.kind === ts.SyntaxKind.AsteriskEqualsToken;
}
export function isAsteriskAsteriskEqualsToken(node: ts.Node): node is ts.Token<ts.SyntaxKind.AsteriskAsteriskEqualsToken> {
  return node.kind === ts.SyntaxKind.AsteriskAsteriskEqualsToken;
}
export function isSlashEqualsToken(node: ts.Node): node is ts.Token<ts.SyntaxKind.SlashEqualsToken> {
  return node.kind === ts.SyntaxKind.SlashEqualsToken;
}
export function isPercentEqualsToken(node: ts.Node): node is ts.Token<ts.SyntaxKind.PercentEqualsToken> {
  return node.kind === ts.SyntaxKind.PercentEqualsToken;
}
export function isLessThanLessThanEqualsToken(node: ts.Node): node is ts.Token<ts.SyntaxKind.LessThanLessThanEqualsToken> {
  return node.kind === ts.SyntaxKind.LessThanLessThanEqualsToken;
}
export function isGreaterThanGreaterThanEqualsToken(node: ts.Node): node is ts.Token<ts.SyntaxKind.GreaterThanGreaterThanEqualsToken> {
  return node.kind === ts.SyntaxKind.GreaterThanGreaterThanEqualsToken;
}
export function isGreaterThanGreaterThanGreaterThanEqualsToken(node: ts.Node): node is ts.Token<ts.SyntaxKind.GreaterThanGreaterThanGreaterThanEqualsToken> {
  return node.kind === ts.SyntaxKind.GreaterThanGreaterThanGreaterThanEqualsToken;
}
export function isAmpersandEqualsToken(node: ts.Node): node is ts.Token<ts.SyntaxKind.AmpersandEqualsToken> {
  return node.kind === ts.SyntaxKind.AmpersandEqualsToken;
}
export function isBarEqualsToken(node: ts.Node): node is ts.Token<ts.SyntaxKind.BarEqualsToken> {
  return node.kind === ts.SyntaxKind.BarEqualsToken;
}
export function isCaretEqualsToken(node: ts.Node): node is ts.Token<ts.SyntaxKind.CaretEqualsToken> {
...
export function isTypeParameter(node: ts.Node): node is ts.TypeParameterDeclaration {
...
export function isConstructor(node: ts.Node): node is ts.ConstructorDeclaration {
...
export function isCallSignature(node: ts.Node): node is ts.CallSignatureDeclaration {
  return node.kind === ts.SyntaxKind.CallSignature;
}
export function isConstructSignature(node: ts.Node): node is ts.ConstructSignatureDeclaration {
  return node.kind === ts.SyntaxKind.ConstructSignature;
}
export function isIndexSignature(node: ts.Node): node is ts.IndexSignatureDeclaration {
...
export function isConstructorType(node: ts.Node): node is ts.ConstructorTypeNode {
...
export function isIntersectionType(node: ts.Node): node is ts.IntersectionTypeNode {
  return node.kind === ts.SyntaxKind.IntersectionType;
}
export function isParenthesizedType(node: ts.Node): node is ts.ParenthesizedTypeNode {
...
export function isIndexedAccessType(node: ts.Node): node is ts.IndexedAccessTypeNode {
...
// export function isTypeAssertionExpression(node: ts.Node): node is ts.TypeAssertionExpression {
...
// export function isJSDocNullKeyword(node: ts.Node): node is ts.JSDocNullKeyword {
//   return node.kind === ts.SyntaxKind.JSDocNullKeyword;
// }
// export function isJSDocUndefinedKeyword(node: ts.Node): node is ts.JSDocUndefinedKeyword {
//   return node.kind === ts.SyntaxKind.JSDocUndefinedKeyword;
// }
// export function isJSDocNeverKeyword(node: ts.Node): node is ts.JSDocNeverKeyword {
...
// }
// export function isFirstCompoundAssignment(node: ts.Node): node is ts.FirstCompoundAssignment {
//   return node.kind === ts.SyntaxKind.FirstCompoundAssignment;
// }
// export function isLastCompoundAssignment(node: ts.Node): node is ts.LastCompoundAssignment {
//   return node.kind === ts.SyntaxKind.LastCompoundAssignment;
// }
// export function isFirstReservedWord(node: ts.Node): node is ts.FirstReservedWord {
//   return node.kind === ts.SyntaxKind.FirstReservedWord;
// }
// export function isLastReservedWord(node: ts.Node): node is ts.LastReservedWord {
...
// }
// export function isFirstFutureReservedWord(node: ts.Node): node is ts.FirstFutureReservedWord {
//   return node.kind === ts.SyntaxKind.FirstFutureReservedWord;
// }
// export function isLastFutureReservedWord(node: ts.Node): node is ts.LastFutureReservedWord {
...
// }
// export function isFirstPunctuation(node: ts.Node): node is ts.FirstPunctuation {
...
// }
export function isFirstToken(node: ts.Node): node is ts.Token<ts.SyntaxKind.FirstToken> {
  return node.kind === ts.SyntaxKind.FirstToken;
}
export function isLastToken(node: ts.Node): node is ts.Token<ts.SyntaxKind.LastToken> {
  return node.kind === ts.SyntaxKind.LastToken;
}
export function isFirstTriviaToken(node: ts.Node): node is ts.Token<ts.SyntaxKind.FirstTriviaToken> {
  return node.kind === ts.SyntaxKind.FirstTriviaToken;
}
export function isLastTriviaToken(node: ts.Node): node is ts.Token<ts.SyntaxKind.LastTriviaToken> {
  return node.kind === ts.SyntaxKind.LastTriviaToken;
}
export function isFirstLiteralToken(node: ts.Node): node is ts.Token<ts.SyntaxKind.FirstLiteralToken> {
  return node.kind === ts.SyntaxKind.FirstLiteralToken;
}
export function isLastLiteralToken(node: ts.Node): node is ts.Token<ts.SyntaxKind.LastLiteralToken> {
  return node.kind === ts.SyntaxKind.LastLiteralToken;
}
export function isFirstTemplateToken(node: ts.Node): node is ts.Token<ts.SyntaxKind.FirstTemplateToken> {
  return node.kind === ts.SyntaxKind.FirstTemplateToken;
}
export function isLastTemplateToken(node: ts.Node): node is ts.Token<ts.SyntaxKind.LastTemplateToken> {
  return node.kind === ts.SyntaxKind.LastTemplateToken;
}
// export function isFirstBinaryOperator(node: ts.Node): node is ts.FirstBinaryOperator {
//   return node.kind === ts.SyntaxKind.FirstBinaryOperator;
// }
// export function isLastBinaryOperator(node: ts.Node): node is ts.LastBinaryOperator {
...
// }
// export function isFirstJSDocTagNode(node: ts.Node): node is ts.FirstJSDocTagNode {
//   return node.kind === ts.SyntaxKind.FirstJSDocTagNode;
// }
// export function isLastJSDocTagNode(node: ts.Node): node is ts.LastJSDocTagNode {
