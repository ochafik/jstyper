...
function flagsTester(...flagss: ts.TypeFlags[]): (testee: ts.Type|ts.TypeFlags|
                                                  undefined) => boolean {
  return (testee) => {
...
export const isBoolean =
    flagsTester(ts.TypeFlags.Boolean, ts.TypeFlags.BooleanLiteral);
export const isBooleanLike = flagsTester(ts.TypeFlags.BooleanLike);
export const isNull = flagsTester(ts.TypeFlags.Null);
export const isNullOrUndefined =
    flagsTester(ts.TypeFlags.Null, ts.TypeFlags.Undefined);
export const isNumber =
    flagsTester(ts.TypeFlags.Number, ts.TypeFlags.NumberLiteral);
export const isNumberOrString = flagsTester(
    ts.TypeFlags.Number, ts.TypeFlags.NumberLiteral, ts.TypeFlags.String,
    ts.TypeFlags.StringLiteral, ts.TypeFlags.StringOrNumberLiteral);
export const isObject = flagsTester(ts.TypeFlags.String, ts.TypeFlags.Object);
export const isString =
    flagsTester(ts.TypeFlags.String, ts.TypeFlags.StringLiteral);
...
//     return Object.keys(ts.SyntaxKind).find(k => ts.SyntaxKind[k] ==
//     node.kind);
// }